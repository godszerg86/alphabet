document.addEventListener('DOMContentLoaded', function () {
    ...
    function cardLayoutGenerator() {
        // array of cards 
        const starterArray = ['a','b','c','d','e','f','g','h','i','j','k','l','m','n','o','p','q','r','s','t','u','v','w','x','y','z'];
        //shuffle created array
        shuffle(starterArray);
        //slicing frist 8 elements
        let builderArray = starterArray.slice(0,8);
        // concatenate array with it self to het 16 elements
        builderArray = builderArray.concat(builderArray);
        // shuffle it
        shuffle(builderArray);
        ...
        for (let i = 0; i < builderArray.length; i++) {
            htmlCardGrid = htmlCardGrid + `<div class="card-container">
            <div class="flipper">
                <div class="front"></div>
                <div class="back">
                    <img src="alphabet/${builderArray[i]}.png" alt="">
                </div>
            </div>
        </div>`;
        }
